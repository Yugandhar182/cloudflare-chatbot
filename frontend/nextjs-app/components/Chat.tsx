          ...
          <div className="flex-1 overflow-y-auto px-4 py-6 space-y-6">
            {messages.length === 0 && (
              <div className="text-center py-12">
                ...
                <p className="text-gray-600 mb-8">I can help you learn about our services, technologies, and capabilities.</p>
                ...
                <div className="grid md:grid-cols-3 gap-4 max-w-2xl mx-auto">
                  ...
                  <button 
                    onClick={() => setInput("How long does a typical project take?")}
                    className="p-4 bg-white rounded-lg shadow-sm border hover:shadow-md transition-shadow text-left"
                  >
                    <div className="text-blue-600 font-medium mb-1">Project Timeline</div>
                    <div className="text-sm text-gray-600">Duration & planning</div>
                  </button>
                </div>
              </div>
            )}
